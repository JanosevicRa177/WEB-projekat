...
<div style="text-align:center;">
	<h1 style="font-size: 70px;">WELCOME TO SPORT ARENA</h1>
        ...
        <h1>Sport objects:</h1>
    		<table border="3" style="margin-left:auto; margin-right:auto;height:400px;width:100%;display:block;background-color: #161515;color:#EA2900;">
    			<thead style="width: 100%;height: 67px; display: inline-block;">
		    		<tr bgcolor="lightgrey" style="width:100%;">
	    		...
	    		<tbody style="width: 99.8%;height: 326px;display: inline-block; overflow: auto;">
