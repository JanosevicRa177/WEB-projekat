...
<div style="text-align:center;">
    ...
    <td>
        ...
        <td align="left"><strong style="font-size: 30px;">Type:</strong></td>
             <td><select style="font-size: 25px; width: 350px;">
        ...
        <td align="left"><strong style="font-size: 30px;">Manager:</strong></td>
            <td><select name="sportB" id="sportB" v-model="sportBuilding.manager" style="font-size: 25px; width: 350px;">
    ...
    <div style="text-align:left;">
	    <p style="font-size:20px;" v-show=nameNotValid>You should valid enter name(first letter uppercase without numbers)</p>
    		...
    		<td>
    		<div style="text-align:center;">
    <p> Register manager if there is not available managers </p>
            <table style="margin-left:auto; margin-right:auto;">
        <tr>
    	...
    	<td align="left"><strong style="font-size: 30px;">Gender:</strong></td>
            <td><select v-bind:disabled="regMan==false"  name="gender" id="gender" v-model="user.gender" style="font-size: 25px; width: 350px;">
	    ...
	    <p :style="{visibility: regMan ? 'visible' : 'hidden'}" style="font-size:20px;" v-show=nameNotValid>You should valid enter name(first letter uppercase without numbers)</p>
	    <p :style="{visibility: regMan ? 'visible' : 'hidden'}" style="font-size:20px;" v-show=surnameNotValid>You valid should enter surname(first letter uppercase without numbers)</p>
    </div>
    		</div> 
    		</td>
    </tr>
...
`
	...
	methods : {
		...
		this.allManagers = data;
		    if(this.allManagers == null) regMan = true;
		},
